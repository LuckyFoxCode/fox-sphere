<template>
  ...
  >
    ...
    <path
      ...
      fill-rule="evenodd"
      clip-rule="evenodd"
      d="M102 48.4641C105.713 46.3205 110.287 46.3205 114 48.4641L161.756 76.0359C165.469 78.1795 167.756 82.1411 167.756 86.4282V141.572C167.756 145.859 165.469 149.821 161.756 151.964L114 179.536C110.287 181.68 105.713 181.68 102 179.536L54.2442 151.964C50.5314 149.821 48.2442 145.859 48.2442 141.572L48.2442 86.4282C48.2442 82.1411 50.5314 78.1795 54.2442 76.0359L102 48.4641Z"
      fill="#0602F3"
    ...
    <path
      ...
      fill="url(#paint0_linear_503_8786)"
      stroke="url(#paint1_linear_503_8786)"
      stroke-width="3"
    ...
    <path
      ...
      fill="url(#paint2_linear_503_8786)"
      stroke="url(#paint3_linear_503_8786)"
      stroke-width="3"
      stroke-linecap="round"
      stroke-linejoin="round"
    />
    ...
    <g mask="url(#mask3_503_8786)">
      <g opacity="0.04">
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M98.9955 38.0302C104.565 34.8148 111.426 34.8148 116.995 38.0302L164.091 65.2208C169.66 68.4362 173.091 74.3785 173.091 80.8093V135.191C173.091 141.621 169.66 147.564 164.091 150.779L116.995 177.97C111.426 181.185 104.565 181.185 98.9955 177.97L51.8999 150.779C46.3307 147.564 42.8999 141.621 42.8999 135.191L42.8999 80.8093C42.8999 74.3785 46.3307 68.4362 51.8999 65.2208L98.9955 38.0302Z"
          fill="#0602F3"
          style="mix-blend-mode: multiply"
        />
      </g>
    ...
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
      d="M147 52.0619C147 50.0435 145.047 48.601 143.118 49.1946L108 60L72.8822 49.1946C70.9531 48.601 69 50.0435 69 52.0619V96C69 97.6569 70.3431 99 72 99H144C145.657 99 147 97.6569 147 96V52.0619Z"
      fill="url(#paint4_linear_503_8786)"
      stroke="url(#paint5_linear_503_8786)"
      stroke-width="3"
      stroke-linecap="round"
      stroke-linejoin="round"
    />
    ...
    <path
      ...
      fill="url(#paint6_linear_503_8786)"
      stroke="#FFF04D"
      stroke-opacity="0.4"
      stroke-width="3"
    />
    <path
      d="M113.25 43.7632C110.001 41.8875 105.999 41.8875 102.75 43.7632L54.9942 71.335C51.7455 73.2106 49.7442 76.677 49.7442 80.4282L49.7442 135.572C49.7442 139.323 51.7455 142.789 54.9942 144.665L102.75 172.237C105.999 174.113 110.001 174.113 113.25 172.237L161.006 144.665C164.254 142.789 166.256 139.323 166.256 135.572V80.4282C166.256 76.677 164.254 73.2106 161.006 71.335L113.25 43.7632Z"
      stroke="#F9B307"
      stroke-width="3"
    />
    <path
    ...
    />
    <path
      d="M166.256 135.572V80.4282C166.256 76.677 164.254 73.2106 161.006 71.335L113.25 43.7632C110.001 41.8875 105.999 41.8875 102.75 43.7632L54.9942 71.335C51.7455 73.2106 49.7442 76.677 49.7442 80.4282L49.7442 135.572"
      stroke="#FAC00E"
      stroke-width="3"
      stroke-linecap="round"
    />
    <path
      opacity="0.6"
      d="M166.256 80.4282C166.256 76.677 164.254 73.2106 161.006 71.335L113.25 43.7632C110.001 41.8875 105.999 41.8875 102.75 43.7632L54.9942 71.335C51.7455 73.2106 49.7442 76.677 49.7442 80.4282"
      stroke="#FDDB3D"
      stroke-width="3"
      stroke-linecap="round"
    />
    ...
    />
    <path
      d="M102.75 43.7631C102.75 43.7631 94.3251 48.6272 90.811 50.6561"
      stroke="white"
      stroke-width="3"
      stroke-linecap="round"
    />
    <g filter="url(#filter2_d_503_8786)">
      <path
        ...
        fill="url(#paint7_linear_503_8786)"
      />
      <path
        d="M104.469 60.3115C106.748 59.0946 109.502 59.1348 111.75 60.4326L147.319 80.9688C149.64 82.3085 151.069 84.7845 151.069 87.4639V128.536C151.069 131.216 149.64 133.692 147.319 135.031L111.75 155.567C109.502 156.865 106.748 156.905 104.469 155.688L104.25 155.567L68.6806 135.031C66.3602 133.692 64.9307 131.216 64.9306 128.536V87.4639C64.9307 84.7845 66.3602 82.3085 68.6806 80.9688L104.25 60.4326L104.469 60.3115Z"
        stroke="#F5900D"
        stroke-opacity="0.1"
        style="mix-blend-mode: multiply"
        stroke-width="3"
    ...
    <g mask="url(#mask5_503_8786)">
      ...
      <path
        opacity="0.4"
        d="M145.819 83.5669L110.25 63.031C108.858 62.2272 107.142 62.2272 105.75 63.031C101.567 65.4463 98.6026 67.1576 96.8576 68.165C93.2262 70.2616 90.2621 71.973 87.9653 73.299C84.0132 75.5808 78.085 79.0034 70.1807 83.5669"
        stroke="white"
        stroke-width="3"
        stroke-linecap="round"
      />
      ...
      />
      <path
        d="M105.75 63.0309C101.567 65.4462 98.6026 67.1575 96.8576 68.1649"
        stroke="white"
        stroke-width="3"
        stroke-linecap="round"
      />
    ...
    <g filter="url(#filter3_d_503_8786)">
      ...
      />
      <path
        d="M108 83.3068C108.989 83.3069 109.916 83.7944 110.475 84.6105L117.522 94.8927L129.48 98.4191C130.429 98.6988 131.179 99.4283 131.485 100.369C131.79 101.31 131.612 102.342 131.009 103.126L123.407 113.005L123.75 125.468C123.777 126.457 123.314 127.396 122.514 127.978C121.713 128.559 120.677 128.709 119.745 128.377L107.999 124.2L96.2541 128.377C95.3219 128.709 94.286 128.559 93.4855 127.978C92.6851 127.396 92.223 126.457 92.2502 125.468L92.592 113.006L84.9904 103.126C84.3871 102.342 84.2091 101.31 84.5148 100.369C84.8206 99.4284 85.5709 98.6989 86.5197 98.4191L98.4768 94.8937L105.526 84.6105L105.634 84.462C106.2 83.7357 107.072 83.3068 108 83.3068Z"
        stroke="white"
        stroke-width="6"
        stroke-linejoin="round"
      />
    ...
    <path
      d="M100.349 97.4699L108 86.3068L115.65 97.4699L128.631 101.296L120.379 112.022L120.751 125.55L108 121.016L95.2489 125.55L95.621 112.022L87.3684 101.296L100.349 97.4699Z"
      fill="url(#paint8_linear_503_8786)"
    />
    <path
      opacity="0.4"
      d="M108 108V86.3068L100.248 97.3163L108 108Z"
      fill="url(#paint9_linear_503_8786)"
    />
    <path
      opacity="0.8"
      d="M108 108L100.248 97.3163L87.3684 101.296L108 108Z"
      fill="url(#paint10_linear_503_8786)"
    />
    <path
      opacity="0.5"
      d="M108 108L95.4475 112.084L95.2489 125.55L108 108Z"
      fill="url(#paint11_linear_503_8786)"
    />
    <path
      opacity="0.4"
      d="M120.751 125.55L120.552 112.084L108 108L120.751 125.55Z"
      fill="url(#paint12_linear_503_8786)"
    />
    <path
    ...
    <path
      opacity="0.6"
      d="M128.631 101.296L115.752 97.3163L108 108L128.631 101.296Z"
      fill="url(#paint13_linear_503_8786)"
    />
    ...
    <defs>
      ...
      >
        ...
        <feBlend
          ...
          result="effect1_dropShadow_503_8786"
        />
        <feBlend
          mode="normal"
          in="SourceGraphic"
          in2="effect1_dropShadow_503_8786"
          result="shape"
        />
      </filter>
      <filter
        id="filter1_d_503_8786"
        x="81.2153"
        y="99"
        width="102.48"
        height="121.512"
