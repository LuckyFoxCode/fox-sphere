<template>
  <div
    class="border-line bg-card flex h-90 w-150 flex-col items-center gap-y-11 rounded-xl border-13 pt-11"
  >
    <div class="border-line flex size-37.5 items-center justify-center rounded-full border-5">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        class="text-lime size-32"
      >
        <path
          fill="currentColor"
    ...
    <div class="flex flex-col items-center text-xl">
      <p>🎰 Weekly Lottery Started!</p>
      <p>Spinning the Wheel of Fortune on overlay... 🎰</p>
    </div>
  </div>
</template>
